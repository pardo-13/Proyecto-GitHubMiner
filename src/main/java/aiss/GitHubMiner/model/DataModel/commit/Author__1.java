...
public class Author__1 {
    ...
    public Author__1 withLogin(String login) {
        this.login = login;
        return this;
    }
    ...
    public Author__1 withId(Integer id) {
        this.id = id;
        return this;
    }
    ...
    public Author__1 withNodeId(String nodeId) {
        this.nodeId = nodeId;
        return this;
    }
    ...
    public Author__1 withAvatarUrl(String avatarUrl) {
        this.avatarUrl = avatarUrl;
        return this;
    }
    ...
    public Author__1 withGravatarId(String gravatarId) {
        this.gravatarId = gravatarId;
        return this;
    }
    ...
    public Author__1 withUrl(String url) {
        this.url = url;
        return this;
    }
    ...
    public Author__1 withHtmlUrl(String htmlUrl) {
        this.htmlUrl = htmlUrl;
        return this;
    }
    ...
    public Author__1 withFollowersUrl(String followersUrl) {
        this.followersUrl = followersUrl;
        return this;
    }
    ...
    public Author__1 withFollowingUrl(String followingUrl) {
        this.followingUrl = followingUrl;
        return this;
    }
    ...
    public Author__1 withGistsUrl(String gistsUrl) {
        this.gistsUrl = gistsUrl;
        return this;
    }
    ...
    public Author__1 withStarredUrl(String starredUrl) {
        this.starredUrl = starredUrl;
        return this;
    }
    ...
    public Author__1 withSubscriptionsUrl(String subscriptionsUrl) {
        this.subscriptionsUrl = subscriptionsUrl;
        return this;
    }
    ...
    public Author__1 withOrganizationsUrl(String organizationsUrl) {
        this.organizationsUrl = organizationsUrl;
        return this;
    }
    ...
    public Author__1 withReposUrl(String reposUrl) {
        this.reposUrl = reposUrl;
        return this;
    }
    ...
    public Author__1 withEventsUrl(String eventsUrl) {
        this.eventsUrl = eventsUrl;
        return this;
    }
    ...
    public Author__1 withReceivedEventsUrl(String receivedEventsUrl) {
        this.receivedEventsUrl = receivedEventsUrl;
        return this;
    }
    ...
    public Author__1 withType(String type) {
        this.type = type;
        return this;
    }
    ...
    public Author__1 withUserViewType(String userViewType) {
        this.userViewType = userViewType;
        return this;
    }
    ...
    public Author__1 withSiteAdmin(Boolean siteAdmin) {
        this.siteAdmin = siteAdmin;
        return this;
    }
    ...
    public Author__1 withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
